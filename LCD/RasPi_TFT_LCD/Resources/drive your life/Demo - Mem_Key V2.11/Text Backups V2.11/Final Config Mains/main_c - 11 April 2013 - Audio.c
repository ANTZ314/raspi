...
Audio track loop back to play next track

-> re-initialise the PDCA or DMA controller sync to SSC (line 207) ?
 ...
 * -> Picking key press from Waynes Keypad
 
 * MUST FIX:
 * => Adapt keys to match the ordered keypad
...
{
	/*
	Only need to check 7 keys:	- 4 x directional keys
								- 'Select' & 'Return' 
								- 'Power'
								
	On main screen can check:	- 'Select'
								- 4 x Advertising keys
