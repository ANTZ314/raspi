...
{	
	...
	gpio_set_pin_high(LED1);					// RED LED on
...
//  Audio_Decode(filename2);
	...
	while (1)
	{
		for (short count=1; count<=12; count++)
		{
			// Audio Test!
			Get_Audio_file(filename1, (count+20));
			Audio_Decode(filename1);
		}
	}		
}
...
//=========================================================================
			...
			// gpio_set_pin_low(ROW3);							// pulled low start - high at end of function
			...
			if (esc == false)									// move image 
			{
				...
				break;											// break from loop OR function ? ?
			}
         }
       }
/* ==================================================================== *
...
//=========================================================================
   ...
   // Close file
   close(fd);											// fd = '0'
   gpio_set_pin_high(ROW3);								// keypad cross pin
