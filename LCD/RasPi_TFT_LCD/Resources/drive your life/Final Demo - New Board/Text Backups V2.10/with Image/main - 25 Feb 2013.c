...
unsigned short					im_no			= 0;		// number passed to Get_File_Name()
...
void Get_Audio_file(char * buf, int choice)
 {
	...
	//unsigned char folder[22] = "A:/Folder2\\File1.raw";
	unsigned char Audio0[22] = "A:/Folder2\\File1.raw";		// NoDeliveryVehicles
	unsigned char Audio1[22] = "A:/Folder2\\File2.raw";		// NoDeliveryVehicles + QT
	unsigned char Audio2[22] = "A:/Folder2\\File3.raw";		// ParkingForConstructionVehicles
	unsigned char Audio3[22] = "A:/Folder2\\File4.raw";		// ParkingForConstructionVehicles + QT
	unsigned char Audio4[22] = "A:/Folder2\\File5.raw";		// TollRoad
	unsigned char Audio5[22] = "A:/Folder2\\File6.raw";		// TollRoad + QT
	unsigned char Audio6[22] = "A:/Folder2\\File7.raw";		// ParkingMidiBus
	unsigned char Audio7[22] = "A:/Folder2\\File8.raw";		// ParkingMidiBus + QT
	unsigned char Audio8[22] = "A:/Folder2\\File9.raw";		// NoLoudNoise
	unsigned char Audio9[22] = "A:/Folder2\\FileA.raw";		// NoLoudNoise + QT
	unsigned char AudioA[22] = "A:/Folder2\\FileB.raw";		// FreewayBegins
	unsigned char AudioB[22] = "A:/Folder2\\FileC.raw";		// FreewayBegins + QT
	unsigned char AudioC[22] = "A:/Folder2\\FileD.raw";		// MinimumSpeed
	unsigned char AudioF[22] = "A:/Folder2\\FileE.raw";		// MinimumSpeed + QT
	unsigned char AudioD[22] = "A:/Folder2\\FileF.raw";		// NoAbnormalVehicles
	unsigned char AudioE[22] = "A:/Folder2\\FileG.raw";		// NoAbnormalVehicles + QT
	unsigned char AudioZ[22] = "A:/Folder2\\LOUDA.raw";		// Intro Track
	...
	switch(choice)
	{
		case '1':	while (k<22)					// File1.raw
					{
						folder1[k] = Audio0[k];
						k++;
					}
					break;
		case '2':	while (k<22)					// File2.raw
					{
						folder1[k] = Audio1[k];
						k++;
					}
					break;
		case '3':	while (k<22)					// File3.raw
					{
						folder1[k] = Audio2[k];
						k++;
					}
					break;
		case '4':	while (k<22)					// File4.raw
					{
						folder1[k] = Audio3[k];
						k++;
					}
					break;
		case '5':	while (k<22)					// File5.raw
					{
						folder1[k] = Audio4[k];
						k++;
					}
					break;
		case '6':	while (k<22)					// File6.raw
					{
						folder1[k] = Audio5[k];
						k++;
					}
					break;
		case '7':	while (k<22)					// File7.raw
					{
						folder1[k] = Audio6[k];
						k++;
					}
					break;
		case '8':	while (k<22)					// File8.raw
					{
						folder1[k] = Audio7[k];
						k++;
					}
					break;
		case '9':	while (k<22)					// File9.raw
					{
						folder1[k] = Audio8[k];
						k++;
					}
					break;
		case 'A':	while (k<22)					// FileA.raw
					{
						folder1[k] = Audio9[k];
						k++;
					}
					break;
		case 'B':	while (k<22)					// FileB.raw
					{
						folder1[k] = AudioA[k];
						k++;
					}
					break;
		case 'C':	while (k<22)					// FileC.raw
					{
						folder1[k] = AudioB[k];
						k++;
					}
					break;
		case 'D':	while (k<22)					// FileD.raw
					{
						folder1[k] = AudioC[k];
						k++;
					}
					break;
		default:	while (k<22)					// FileZ.raw -> LOUDA intro
					{
						folder1[k] = AudioZ[k];
						k++;
					}
