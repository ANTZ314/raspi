...
If face recognised (display response image) "do something", if not "do something else"

Usage:
python3 faceRecResp.py --encodings encodings.pickle --image /home/antz/0_samples/faceRec/examples/ex1.png
"""
