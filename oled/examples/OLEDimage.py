...
# This program takes any image (recommended: landscape) and converts it into a 
# black and white image which is then  displayed on one of Adafruit's monochrome OLED displays. 

# To run the code simply change directory to where it is saved and then type: 
# sudo python OLEDimage.py <image name>
# For example: sudo python OLEDimage.py penguins900x600.jpg
# The image penguins900x600.jpg is included in this repo as an example! 
# Download any image that you want and simply change the image name!
...
# Sets up our pins and creates variables for the size of the display. 
# If using other size display you can easily change them.
...
RESET_PIN = 5 	# WiringPi pin 15 is GPIO08.
DC_PIN    = 6 	# WiringPi pin 16 is GPIO10.
width 	  = 128
height    = 32

#led = Adafruit_SSD1306.SSD1306_128_64(reset_pin=REST_PIN, dc_pin=DC_PIN)
