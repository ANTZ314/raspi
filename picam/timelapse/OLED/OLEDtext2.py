...
class OLEDtext:
	...
	def draw(self, interval, frame):
		Frames = ""									# initialise string
		Interval = ""								# initialise string
		
		text = 'TimeLapse!'							# allows 9 chars + !
		self.led.draw_text2(0,0,text,2)
			
		Interval = "Interval: " + str(interval) + "sec"
		print(Interval)
		#text2= '1234567890123456789'				# allows 19 small across
		text2 = "Interval: " + str(interval) + "sec"
		self.led.draw_text2(0,16,text2,1)
			
		Frames = "Frames:   " + str(frame)
		print(Frames)
		#text2= '1234567890123456789'				# allows 19 small across
		text3 = "Frames:   " + str(frame)
