...
#- - - - - - - - - - - - - - - -HELPER FUNCTIONS- - - - - - - - - - - - - - - - 
    ...
    def post(self, url, json):
        with self.api_thread_lock:
            try:
                dat = requests.post(url, json = json)
                res = dat.status_code
            except:
                res = 0
            return res
...
#- - - - - - - - - - - - - - - RETRIEVE FUNCTIONS - - - - - - - - - - - - - - -        
    ...
    # <note> To fetch values, please not the variable names stored in insert_event </note>
    def list_event(self):
    ...
    # <note> To fetch values, please not the variable names stored in insert_status </note>
    ...
    # <note> To fetch values, please not the variable names stored in insert_error </note>
    def list_error(self):
    ...
    # <note> To fetch values, please not the variable names stored in insert_update </note>
