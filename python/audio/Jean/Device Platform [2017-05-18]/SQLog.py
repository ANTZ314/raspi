...
#- - - - - - - - - - - - - - - STATUS LOG TABLE - - - - - - - - - - - - - - - -   
    ...
    def create_Status_Log_table(self):
        ...
        self.sql_do('''CREATE TABLE Status_Log ( event_id INTEGER PRIMARY KEY NOT NULL, 
                                                 dts STRING, 
                                                 uptime STRING,
                                                 module_longitude STRING,
                                                 module_latitude STRING,
                                                 gps_status INTEGER, 
                                                 gps_signal INTEGER, 
                                                 status_3g INTEGER, 
                                                 signal_3g INTEGER, 
    ...
    def insert_Status_Log_table(self, insert_data):
        acceptable_data = ('dts', 'gps_signal', 'uptime', 'module_longitude', 'ac_power',
                           'signal_3g', 'mic_status', 'module_latitude', 'storage_status',
                           'snr', 'battery_status', 'cover_status', 'cpu_temp', 'ram',
                           'api_response','network_usage', 'cpu_utilization')
